...
print '\x1b[92m[ Fb      : Jarr                             ]'
print '\x1b[92m[  https://www.facebook.com/100005394462822  ]'
...
try:
    ...
    print '\x1b[91m[!] Coba lihat email dan sandi anda'
    exit()

print '\x1b[92m  ______                                       __ \n /      \\                                     /  |\n/$$$$$$  | __    __   ______    ______    ____$$ |\n$$ | _$$/ /  |  /  | /      \\  /      \\  /    $$ |\n$$ |/    |$$ |  $$ | $$$$$$  |/$$$$$$  |/$$$$$$$ |\n$$ |$$$$ |$$ |  $$ | /    $$ |$$ |  $$/ $$ |  $$ |\n$$ \\__$$ |$$ \\__$$ |/$$$$$$$ |$$ |      $$ \\__$$ |\n$$    $$/ $$    $$/ $$    $$ |$$ |      $$    $$ |\n $$$$$$/   $$$$$$/   $$$$$$$/ $$/        $$$$$$$/ '
print '\x1b[0mMenu List'
print '\x1b[93m[01] Aktifkan'
print '\x1b[93m[02] Non-Aktif'
